...
if (m.money) m.reply(+m.money + ' 𝙍𝙮𝙯𝙤𝘽𝙤𝙩-𝙈𝘿')
break
}
} catch (e) {
console.error(e)
...
if (db.data.chats[m.chat].reaction && m.text.match(/(بوت|بوتات|رياض|ريزو|بوتت|ب|و|ت|.|البوت|bot|ت|ث|ي)/gi)) {
let emot = pickRandom([
'😀',
'😃',
'😄',
...
.replace('@desc', groupMetadata.desc?.toString() || '⟐ 𝗦𝘂𝗽𝗲𝗿 𝗥𝘆𝘇𝗼𝗕𝗼𝘁-𝗠𝗗 ⟐')
...
thumbnail: apii.data,
title: [wm, '⟐ 𝙍𝙮𝙯𝙤𝘽𝙤𝙩-𝙈𝘿 ' + gt + ' ⟐', '🌟 riyadmosa5.gmail.com'].getRandom(),
...
body: [wm, '⟐ 𝙍𝙮𝙯𝙤𝘽𝙤𝙩-𝙈𝘿 ' + gt + ' ⟐', '🌟 riyadmosa5.gmail.com'].getRandom(),
thumbnail: gataImg,
sourceUrl: accountsgb
}
}
