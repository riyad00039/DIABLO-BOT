...
let pathGataJadiBot = path.join('./DiabloJadiBot/', id)
...
rtx2.trim() + '\n' + drmer.toString('utf-8'),
wm + `\n*〘 الكود 〙:* ${secret}`,
'https://files.catbox.moe/ik0213.jpg' || 'https://qu.ax/wyUjT.jpg',
null,
[['⟐ نـــــــسخ ⟐', secret]],
null,
null,
...
m.chat,
{
image: {url: 'https://h.uguu.se/GUHtpVKY.jpg' || gataMenu.getRandom()},
caption: rtx2.trim() + '\n' + drmer.toString('utf-8')
},
{quoted: m}
)
...
newsletterJid: '120363403316883219@newsletter',
newsletterName: '◌°⃟𑁁🧭◌𝐎𝐰𝐧𝐞𝐫: 𝐑𝐢𝐲𝐚𝐝 𝐂𝐡𝐚𝐧𝐧𝐞𝐥°⃟𑁁🧭',
serverMessageId: -1
}
}
},
...
let chtxt = `*الاتصال بنجاح ✅*\n\n*👤 المستخدم:* ${userName}\n*📞 الرقم:* ${path.basename(pathGataJadiBot)}`.trim()
