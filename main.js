...
global.authFile = 'DiabloSession'
global.authFileJB = 'DiabloJadiBot'
global.rutaBot = join(__dirname, global.authFile)
global.rutaJadiBot = join(__dirname, global.authFileJB)
const respaldoDir = join(__dirname, 'RiyadSession')
...
mobile: MethodMobile,
browser: opcion == '1' ? ['DiabloBot-MD', 'Edge', '20.0.04'] : methodCodeQR ? ['GataBot-MD', 'Edge', '20.0.04'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
if (!printingNoConn) {
printingNoConn = true
await logCritical(chalk.bold.redBright('⚠️ SIN CONEXIÓN, BORRE LA CARPETA DiabloBotSession Y ESCANEA EL CÓDIGO QR ⚠️'))
setTimeout(() => {
